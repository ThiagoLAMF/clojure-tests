...
return (new CustomEvent(event_name,(function (){var obj25402 = ({"detail":data});
return obj25402;
})()));
} else {
...
var f = (function (){var pred__25409 = cljs.core._EQ_;
var expr__25410 = ((figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__25409.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__25410))){
return ((function (pred__25409,expr__25410){
return (function (p1__25403_SHARP_){
return console.warn(p1__25403_SHARP_);
});
;})(pred__25409,expr__25410))
} else {
if(cljs.core.truth_(pred__25409.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__25410))){
return ((function (pred__25409,expr__25410){
return (function (p1__25404_SHARP_){
return console.debug(p1__25404_SHARP_);
});
;})(pred__25409,expr__25410))
} else {
if(cljs.core.truth_(pred__25409.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__25410))){
return ((function (pred__25409,expr__25410){
return (function (p1__25405_SHARP_){
return console.error(p1__25405_SHARP_);
});
;})(pred__25409,expr__25410))
} else {
return ((function (pred__25409,expr__25410){
return (function (p1__25406_SHARP_){
return console.log(p1__25406_SHARP_);
});
;})(pred__25409,expr__25410))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__25413){
...
var eval_fn = cljs.core.get.call(null,map__25414__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__25416_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__25418,(0),null);
...
//# sourceMappingURL=utils.js.map?rel=1569260570902
