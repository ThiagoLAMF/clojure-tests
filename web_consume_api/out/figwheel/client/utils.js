...
return (new CustomEvent(event_name,(function (){var obj25405 = ({"detail":data});
return obj25405;
})()));
} else {
...
var f = (function (){var pred__25412 = cljs.core._EQ_;
var expr__25413 = ((figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__25412.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__25413))){
return ((function (pred__25412,expr__25413){
return (function (p1__25406_SHARP_){
return console.warn(p1__25406_SHARP_);
});
;})(pred__25412,expr__25413))
} else {
if(cljs.core.truth_(pred__25412.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__25413))){
return ((function (pred__25412,expr__25413){
return (function (p1__25407_SHARP_){
return console.debug(p1__25407_SHARP_);
});
;})(pred__25412,expr__25413))
} else {
if(cljs.core.truth_(pred__25412.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__25413))){
return ((function (pred__25412,expr__25413){
return (function (p1__25408_SHARP_){
return console.error(p1__25408_SHARP_);
});
;})(pred__25412,expr__25413))
} else {
return ((function (pred__25412,expr__25413){
return (function (p1__25409_SHARP_){
return console.log(p1__25409_SHARP_);
});
;})(pred__25412,expr__25413))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__25416){
var map__25417 = p__25416;
var map__25417__$1 = (((((!((map__25417 == null))))?(((((map__25417.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__25417.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__25417):map__25417);
var opts = map__25417__$1;
var eval_fn = cljs.core.get.call(null,map__25417__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return (function (p1__25419_SHARP_){
return new_def.callback(p1__25419_SHARP_);
});})(new_def))
);
...
return (function (p__25420){
var vec__25421 = p__25420;
var ky = cljs.core.nth.call(null,vec__25421,(0),null);
var v = cljs.core.nth.call(null,vec__25421,(1),null);
...
}catch (e25426){if((e25426 instanceof Error)){
var e = e25426;
return not_found;
} else {
throw e25426;
...
//# sourceMappingURL=utils.js.map?rel=1568825115522
